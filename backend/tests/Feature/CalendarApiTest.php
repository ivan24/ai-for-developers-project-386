...
class CalendarApiTest extends TestCase
{
    ...
    public function test_owner_profile_and_event_type_crud_flow(): void
    {
    ...
    public function test_owner_bookings_list_detail_and_cancel_flow(): void
    {
    ...
    public function test_public_event_types_and_slots_include_unavailable_slot(): void
    {
        Owner::query()->create([
            'name' => 'Demo Owner',
            'timezone' => 'UTC',
        ...
        $this->assertFalse($targetSlot['isAvailable']);
    }

    public function test_guest_can_create_lookup_and_cancel_booking(): void
    {
        Owner::query()->create([
            'name' => 'Demo Owner',
            'timezone' => 'UTC',
    ...
    public function test_guest_cannot_create_overlapping_active_booking(): void
    {
        Owner::query()->create([
            'name' => 'Demo Owner',
            'timezone' => 'UTC',
    ...
    public function test_validation_errors_return_400_payload(): void
    {
